...
const Schema: z.ZodType<Prisma.ProductQuantityCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductQuantityCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
