...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateWithoutQuantitiesInput> = z
  .object({
    slug: z
      .union([
        z.string(),
...
export const ProductUncheckedUpdateWithoutQuantitiesInputObjectSchema = Schema;
