...
const Schema: z.ZodType<Prisma.ReviewCreateNestedManyWithoutUserInput> = z
  .object({
    create: z
      .union([
        ...
        z.lazy(() => ReviewUncheckedCreateWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    connectOrCreate: z
      .union([
        z.lazy(() => ReviewCreateOrConnectWithoutUserInputObjectSchema),
        z.lazy(() => ReviewCreateOrConnectWithoutUserInputObjectSchema).array(),
      ])
      .optional(),
    createMany: z
...
export const ReviewCreateNestedManyWithoutUserInputObjectSchema = Schema;
