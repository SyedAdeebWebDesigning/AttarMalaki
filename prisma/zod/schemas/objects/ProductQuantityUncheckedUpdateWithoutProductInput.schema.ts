...
const Schema: z.ZodType<Prisma.ProductQuantityUncheckedUpdateWithoutProductInput> =
  z
    .object({
      size: z
        .union([
...
export const ProductQuantityUncheckedUpdateWithoutProductInputObjectSchema =
  Schema;
