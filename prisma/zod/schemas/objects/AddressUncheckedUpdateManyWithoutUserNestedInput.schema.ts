...
const Schema: z.ZodType<Prisma.AddressUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => AddressUpsertWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => AddressUpsertWithWhereUniqueWithoutUserInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => AddressUpdateWithWhereUniqueWithoutUserInputObjectSchema,
          ),
          z
            .lazy(
              () => AddressUpdateWithWhereUniqueWithoutUserInputObjectSchema,
...
export const AddressUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
