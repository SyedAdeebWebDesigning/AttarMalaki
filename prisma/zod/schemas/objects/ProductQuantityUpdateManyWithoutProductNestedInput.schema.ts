...
const Schema: z.ZodType<Prisma.ProductQuantityUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductQuantityUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
